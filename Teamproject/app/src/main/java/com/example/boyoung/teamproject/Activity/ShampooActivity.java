...
import com.example.boyoung.teamproject.ListAdapter.ShampooListAdapter;
...
public class ShampooActivity extends AppCompatActivity {
    ...
    private ShampooListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ShampooActivity.this, LoginActivity.class);
                ShampooActivity.this.startActivity(intent);

            }
        });

        listView = (ListView)findViewById(R.id.listView);
        shampooList = new ArrayList<Shampoo>();
        adapter = new ShampooListAdapter(getApplicationContext(), shampooList);
        ...
        try{
            ...
            while(count<jsonArray.length()){
                ...
                Shampoo shampoo = new Shampoo(stuffname,stuffnum,available,startdate,enddate);
